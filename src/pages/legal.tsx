	...
	return (
		<Layout pageName="Mentions légales" user={user}>
			<div className='flex flex-col'>
                <p className='text-justify mb-2'>Ce site web est la propriété de Adam, Amandine, Line et Valentin.</p>
                ...
                <p className='text-justify mb-2'>E-mail : marketplace@cy-tech.fr</p>
