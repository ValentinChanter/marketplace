...
export default function LoginForm({
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col">
      ...
      <button type="submit" className='text-white border-solid border-3 border-gray-800 rounded bg-teal-500 hover:bg-teal-600 focus:ring-2 focus:ring-blue-300 py-2 my-1'>Connexion</button>
