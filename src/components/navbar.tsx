      ...
      <div className={`${styles.container} bg-mkGreen`}>
        ...
        <div className={styles.rightLogosContainer}>
          {user !== null ? (
                ...
                <ul className="absolute z-10 hidden group-hover:block mt-1 py-2 w-48 bg-white rounded-b-md shadow-lg top-12 right-0">
                  ...
                  <li>
                    <p
                      ...
                      className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 hover:text-gray-900 focus:outline-none focus:bg-gray-100 focus:text-gray-900 transition duration-150 ease-in-out cursor-pointer"
                    >
                      Se déconnecter
                    </p>
                  </li>
            ...
            <div className='m-4'>
              <Link href="/login">
              <svg xmlns="http://www.w3.org/2000/svg" className="fill-mkDarkBlue pb-1" width="2.5em" height="2.5em" viewBox="0 0 20 20"><path d="M9.76 0C15.417 0 20 4.477 20 10S15.416 20 9.76 20c-3.191 0-6.142-1.437-8.07-3.846a.644.644 0 0 1 .115-.918a.68.68 0 0 1 .94.113a8.96 8.96 0 0 0 7.016 3.343c4.915 0 8.9-3.892 8.9-8.692c0-4.8-3.985-8.692-8.9-8.692a8.961 8.961 0 0 0-6.944 3.255a.68.68 0 0 1-.942.101a.644.644 0 0 1-.103-.92C3.703 1.394 6.615 0 9.761 0Zm.545 6.862l2.707 2.707c.262.262.267.68.011.936L10.38 13.15a.662.662 0 0 1-.937-.011a.662.662 0 0 1-.01-.937l1.547-1.548l-10.31.001A.662.662 0 0 1 0 10c0-.361.3-.654.67-.654h10.268L9.38 7.787a.662.662 0 0 1-.01-.937a.662.662 0 0 1 .935.011Z"></path></svg>
          ...
          <div className='m-4'>
            <Link href="/cart">
                <svg 
                    ...
                    viewBox="0 0 256 256">
                    <path  
                        d="M136 120v56a8 8 0 0 1-16 0v-56a8 8 0 0 1 16 0Zm103.86-21.89L226 202.12A16 16 0 0 1 210.13 216H45.87A16 16 0 0 1 30 202.12l-13.87-104A16 16 0 0 1 32 80h36.37L122 18.73a8 8 0 0 1 12 0L187.63 80H224a16 16 0 0 1 15.85 18.11ZM89.63 80h76.74L128 36.15ZM224 96H32l13.87 104h164.26Zm-51.16 23.2l-5.6 56a8 8 0 0 0 7.16 8.8a7.44 7.44 0 0 0 .81 0a8 8 0 0 0 7.95-7.2l5.6-56a8 8 0 0 0-15.92-1.6Zm-89.68 0a8 8 0 0 0-15.92 1.6l5.6 56a8 8 0 0 0 8 7.2a7.44 7.44 0 0 0 .81 0a8 8 0 0 0 7.16-8.76Z">
                    </path>
                </svg>
            </Link>
          </div>
