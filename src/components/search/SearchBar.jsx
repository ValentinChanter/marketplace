...
const hit = ({hit}) => {
    return (
        <div>
            <span>Name: <Highlight attribute='name' hit={hit}/></span>
    ...
    return (
        <>
            <searchContext.Provider value={search}>
                ...
                <input type="search" placeholder="Rechercher un produit" className={styles.search} value={search} onChange={handleChange}/>
